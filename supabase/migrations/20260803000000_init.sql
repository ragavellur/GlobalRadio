...
-- ============================================================================
-- SONOS TOKENS (server-side, per user)
-- Access/refresh tokens from the Sonos OAuth flow, stored so Alexa / other
-- devices can control the user's speakers without relying on a single
-- browser's localStorage. Written and read by the sonos-auth edge function
-- (service role). No RLS policies: anon/authenticated can't touch these rows.
-- ============================================================================
create table if not exists public.sonos_tokens (
...
-- ============================================================================
-- NOW PLAYING (cross-device)
-- Latest playback state per owner key (Alexa userId, app user id, ...) so a
-- returning device can pick up what's playing elsewhere.
-- ============================================================================
