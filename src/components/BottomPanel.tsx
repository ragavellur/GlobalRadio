...
export default function BottomPanel() {
  ...
  return (
    ...
    >
      {/* === Drawer area === */}
      {/* Always flex-end: content sits at bottom, right above play controls */}
      <div
      ...
      >
        {selectedCity && (
          <>
            {/* Drawer handle — always above header, both expanded and collapsed */}
            <button
            ...
            {/* Station list — only visible when expanded */}
            {drawerOpen && (
          ...
          <div className="flex items-center justify-between px-4 pt-3 pb-1">
            <div className="min-w-0 flex-1">
              ...
              <div className="text-[11px] text-white/50 truncate">
                ...
                {audioStatus === 'offline' && (
                  <span style={{ color: '#ff5555', marginLeft: 6 }}>(Offline)</span>
                )}
                {audioStatus === 'loading' && isPlaying && (
                  <span style={{ color: '#ffaa00', marginLeft: 6 }}>(Loading...)</span>
                )}
              </div>
            </div>
            <button
